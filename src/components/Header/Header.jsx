  ...
  return (
    <header className="bg-gradient-to-r from-blue-300 via-blue-300 to-blue-300 shadow-md backdrop-blur-md sticky top-0 z-50 border-b border-blue-300">
      <nav className="max-w-7xl mx-auto px-2 py-1 flex justify-between items-center">
        ...
        >
          <Logo width="100px" />
          <h1 className="text-3xl font-extrabold tracking-wider drop-shadow-sm bg-gradient-to-r from-blue-900 via-blue-600 to-blue-800 bg-[length:300%_300%] bg-clip-text text-transparent animate-gradient-swim">
            DevBlogs
          </h1>
        </div>
            ...
            (item) =>
              item.active && (
                <li key={item.name}>
                  ...
                  >
                    <span className="group-hover:text-blue-950 transition">
                      {item.name}
                    </span>
